...
class TotalDetuction extends StatefulWidget {
  @override
  _TotalDetuctionState createState() => _TotalDetuctionState();
}
              ...
              Container(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, int index) =>
                      ListDeductionItems(detuction[index]),
                        ...
                        children: <Widget>[
                          ...
                          Flexible(
                              child: Container(
                                  ...
                                  child: Text(
                                      salary
                                          .data.salaryDetails[0].totalDeduction
                                          .toString(),
                                      style: TextStyle(
                                          fontSize: 12,
                                          fontWeight: FontWeight.bold,
                          ...
                          Flexible(
                              child: Container(
                                  ...
                                  child: Text(
                                      salary
                                          .data.salaryDetails[0].totalNetSalary
                                          .toString(),
                                      style: TextStyle(
                                          fontSize: 12,
                                          fontWeight: FontWeight.bold,
