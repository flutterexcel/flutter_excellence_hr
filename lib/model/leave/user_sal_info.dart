class UserSalaryInfo {
  ...
  UserSalaryInfo({this.error, this.data});

  UserSalaryInfo.fromJson(Map<String, dynamic> json) {
    error = json['error'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    // if (json['holding_details'] != null) {
    //   holdingDetails = new List<Null>();
    //   json['holding_details'].forEach((v) {
    //     holdingDetails.add(new Null.fromJson(v));
    //   });
    // }
  ...
  Map<String, dynamic> toJson() {
    ...
    // if (this.holdingDetails != null) {
    //   data['holding_details'] =
    //       this.holdingDetails.map((v) => v.toJson()).toList();
    // }
